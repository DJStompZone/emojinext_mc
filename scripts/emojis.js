...
if ((_b = (_a = world.afterEvents) === null || _a === void 0 ? void 0 : _a.entitySpawn) !== null && _b !== void 0 ? _b : null) {
    try {
        (_c = world.afterEvents) === null || _c === void 0 ? void 0 : _c.entitySpawn.subscribe((entityEvent) => {
...
const parseMoji = function (msg) {
    ...
    for (const i of Array((_b = matches === null || matches === void 0 ? void 0 : matches.length) !== null && _b !== void 0 ? _b : 0).keys()) {
        let matched = newmoji[(_d = (_c = matches[i]) === null || _c === void 0 ? void 0 : _c.replaceAll(":", "")) === null || _d === void 0 ? void 0 : _d.toLowerCase()];
        if (!!matched) {
...
const getTranslation = function (msg) {
...
world.beforeEvents.chatSend.subscribe((data) => {
    ...
    else if (data.message.includes("DJ Stomp") &&
